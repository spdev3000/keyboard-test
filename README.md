# Keyboard-test with LitElement TypeScript starter

This project includes a sample component using LitElement with TypeScript and some keyboard listener code.
